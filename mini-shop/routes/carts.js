...
// Receive a post request to add an item to the a cart
router.post('/cart/products', async (req, res) => {
  // Figure out cart exist
  let cart
  if (!req.session.cartId) {
    ...
    // Have a cart! Let's get it from the repository
...
// Receive a post request to delete an item in cart
